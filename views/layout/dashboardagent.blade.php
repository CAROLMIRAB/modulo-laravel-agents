<div class="row">
            ...
            <div class="display">
                <div class="number">
                    <h3 class="font-purple-soft" style="font-size:20px">
                        <span data-counter="counterup" style="font-size:16px">  {{ $agent->balance }}   </span>
                    </h3>
                ...
                <div class="number">
                    <h3 class="font-green-jungle" style="font-size:20px">
                        <span data-counter="counterup"
                              style="font-size:16px"> {{ $agent_profit['amountDebit'] }} </span>
                    </h3>
            ...
            <div class="display">
                <div class="number">
                    <h3 class="font-red-thunderbird" style="font-size:20px">
                        <span data-counter="counterup"
                              style="font-size:16px"> {{ $agent_profit['amountCredit'] }}  </span>
                    </h3>
            ...
            <div class="display">
                <div class="number">
                    <h3 class="font-blue-steel" style="font-size:20px">
                                        <span data-counter="counterup"
                                              style="font-size:16px">  {{ $agent_profit['amountProfit'] }}  </span>
                    </h3>
    ...
    <div class="col-md-6 col-sm-12">
        <div class="form-horizontal">
            ...
            <div class="form-group">
                <label class="col-md-4"><span class="pull-right">{{  __('Detalle') }}</span></label>
                <div class="col-md-8">
                    <strong> {{$agent->description}} </strong>
                </div>
            </div>
            <div class="form-group">
                <label class="col-md-4"><span class="pull-right">{{  __('Agente tipo') }}</span></label>
                <div class="col-md-8">
                    <strong> {!! $agent->agentmaster !!} </strong>
                </div>
            </div>
            <div class="form-group">
    ...
    @if($agent->user <> \Auth::user()->id)
        @if($agent->ownerid == \Auth::user()->id)
            <div class="col-md-6 col-sm-12">
